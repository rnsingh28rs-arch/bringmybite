...
const config: SupabaseRestConfig = {
  // Support both Vite's VITE_* names and the existing Vercel NEXT_PUBLIC_* names.
  url: (import.meta.env.VITE_SUPABASE_URL || import.meta.env.NEXT_PUBLIC_SUPABASE_URL || '').replace(/\/$/, ''),
