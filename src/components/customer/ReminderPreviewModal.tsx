...
📞 Help Desk: 9315075165`;

  const formattedSmsText = `[Bring My Bite] Dear ${targetSub.customerName}, your ${targetSub.packageType} plan (${targetSub.id}) expires in ${daysLeft} days on ${targetSub.expiryDate}. Renew now at https://bringmybite.in/renew?id=${targetSub.id} to ensure continuous meals + 2x monthly bonus. Call: 9315075165`;
