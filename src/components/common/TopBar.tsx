      ...
      <div className="max-w-7xl mx-auto px-4 py-2 flex flex-wrap items-center justify-between gap-3 text-[11px] sm:text-xs">
        ...
        <div className="flex items-center gap-3 sm:gap-4 font-semibold">
          ...
          >
            ...
            <span>9315075165</span>
          </a>
          <a
            href="https://wa.me/919315075165?text=Hello%20Bring%20My%20Bite,%20I%20would%20like%20to%20know%20more%20about%20tiffin%20subscriptions"
            target="_blank"
            rel="noreferrer"
