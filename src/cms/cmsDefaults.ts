...
import { CURRENT_VEG_CLASSIC_MENU } from '../data/currentMenu';
...
export const DEFAULT_BANNERS: BannerConfig[] = [
  {
    ...
    description: 'Pure vegetarian homely meals crafted with fresh seasonal vegetables, rotating dal, rice, warm rotis, papad, salad & achar.',
    features: ['13 Meals / Week (Mon–Sun)', 'Lunch at Gate • Dinner at Home', '18–22g Balanced Protein', 'Fresh Daily Menu'],
    package_key: 'VEG CLASSIC', thali_key: 'veg', image_url: FOOD_IMAGES.vegThali,
    image_alt: 'Pure Vegetarian Homely Thali', dish_highlights: ['Dal Tadka / Makhani', 'Paneer Butter / Aloo Gobhi', 'Jeera Basmati Rice', '4 Warm Rotis + Papad'], ...shared
  },
  {
    ...
    description: 'Specially curated for active students & professionals with rotating egg dishes, seasonal vegetables, rice, rotis, salad & achar.',
    features: ['13 Meals / Week with Egg Delicacies', '20–24g Natural Protein per meal', 'Fresh Farm Grade Eggs', '4 Warm Rotis + Papad'],
    package_key: 'EGG DELIGHT', thali_key: 'egg', image_url: FOOD_IMAGES.eggThali,
    image_alt: 'High Protein Egg Curry Thali', dish_highlights: ['Egg Curry (2 Eggs)', 'Egg Bhurji', 'Steamed Basmati Rice', '4 Warm Rotis + Salad'],
  ...
  },
  {
    ...
    description: 'Home-style Chicken and Egg specialties paired with seasonal vegetables, aromatic rice, rotis, salad & achar.',
    features: ['Chicken & Egg Rotations', '25–30g Muscle-Building Protein', 'Sunday Lunch Included', 'Fresh Daily Menu'],
    package_key: 'NON-VEG CLUB', thali_key: 'non-veg', image_url: FOOD_IMAGES.nonVegThali,
    image_alt: 'Chicken Curry Thali', dish_highlights: ['Chicken Curry (3 pcs)', 'Egg Curry on Rotation', 'Seasonal Vegetables', 'Basmati Rice + 4 Rotis'],
  ...
  },
  {
    ...
    features: ['No Monthly Lock-in Required', '45–60 Minute Direct Gate Delivery', 'Includes 4 Roti, Papad, Salad & Achar'],
    package_key: 'VEG CLASSIC', thali_key: 'veg', image_url: FOOD_IMAGES.instantTiffin,
    image_alt: 'Fresh Hot Meal Thali', dish_highlights: ['Veg Thali (₹100)', 'Egg Thali (₹120)', 'Non-Veg Thali (₹150)', 'Steaming Hot Gate Drop'],
...
export const DEFAULT_MENUS: Record<PackageType, DayMenuSchedule[]> = {
  'VEG CLASSIC': CURRENT_VEG_CLASSIC_MENU,
...
export const DEFAULT_PANELS = [
  ...
  ['customers', 'Customers'], ['orders', 'Orders'], ['inventory', 'Inventory'], ['staff', 'Staff & Permissions'], ['salaries', 'Staff Salaries'], ['gst-billing', 'GST / Corporate Billing']
...
export const DEFAULT_ROLES = [
  ...
  { id: 'chef-helper', name: 'Chef Helper', active: true }
];
